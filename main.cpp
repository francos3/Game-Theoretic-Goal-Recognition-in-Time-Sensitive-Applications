...
void create_grid_edges_from_file(){
  ...
  main_graph.setv();main_graph.set_number_vertices( file_node_counter + 1 );
  ...
  for(size_t dest=0;dest<Destinations.size();dest++){
    ...
    current_graph[dest].setv();current_graph[dest].set_number_vertices( file_node_counter + 1);
    ...
    current_graph_dest_to_dest[dest].setv();current_graph_dest_to_dest[dest].set_number_vertices( file_node_counter + 1 );
