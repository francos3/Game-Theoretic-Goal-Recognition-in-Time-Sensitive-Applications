...
# Set label of y-axis
set ylabel 'RunTime(secs)' font ",18"
...
plot for[i in "PO=75 PO=80 PO=90 PO=95 PO=100" ] filename using 1:i:xticlabel(1) title columnheader with linespoints ps 0.4
#plot for[i in "PO=100" ] filename using 1:i:xticlabel(1) title columnheader with linespoints ps 0.4
