...
folder_path= '/home/ugac002/Dropbox/GO_2023/experiments_FictitiousPlay_K1000_N30_F1-4/'
...
if not skip_extract:
    ...
    with open('data_statistics.csv', 'w', newline='') as csvfile:
        ...
        writer.writerow(['N', 'F', 'R', 'AvgStdDevIter','Average Reward', 'Average StdDev', 'Average CV', 'Average Entries', 'Distinct Cutsets', 'Distinct_Cutsets_std_dev','Last Cutset Size', 'Avg Time','std_dev_Time','Avg Mem','Mean'])
        ...
        for category in sorted_categories:
            ...
            average_CV = round(statistics.mean(values['CV']), 6)
            ...
            writer.writerow([N, F, R,average_stdev2,average_mean_savings, average_std_dev, average_CV, average_entries, average_cutsets, stdev_cutsets, average_size, average_time, stdev_time,average_mem, average_Mean])
...
plt.ylabel('Number of Distinct Cutsets',fontsize=16,fontweight='bold')
